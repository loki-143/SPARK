...
import { Clock, Users, Code, Trophy, CheckCircle, XCircle } from "lucide-react";
...
const ContestPage = () => {
  ...
  const leaderboard = [
    { rank: 1, username: "AlexCoder", score: 1250, penalty: "0:45:23", problems: [true, true, true, true] },
    { rank: 2, username: "PyDev_Pro", score: 1150, penalty: "1:12:45", problems: [true, true, true, false] },
    { rank: 3, username: "CodeNinja", score: 1050, penalty: "1:23:12", problems: [true, true, false, true] },
    { rank: 4, username: "AlgoMaster", score: 850, penalty: "0:56:34", problems: [true, true, false, false] },
    { rank: 5, username: "DevGuru", score: 750, penalty: "1:45:23", problems: [true, false, true, false] }
  ];
              ...
              <CardContent>
                <div className="space-y-4">
                  {leaderboard.map((entry) => (
                    <div key={entry.rank} className="flex items-center justify-between p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                      <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center space-x-6">
                        <div className="flex space-x-2">
                          {entry.problems.map((solved, index) => (
                            <div key={index} className={`w-6 h-6 rounded flex items-center justify-center text-xs
